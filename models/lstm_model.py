"""This module contains DNN with different count of LSTM layers."""
...
def initialize_lstm_1():
    """
    The OCR model with 1 layer LSTM.
    ...
    return models.Model(
        inputs=[input_img, labels], outputs=output, name="OCR_with_LSTM_1"
    )


def initialize_lstm_2():
    """
    The OCR model with 2 layers LSTM.
    ...
    return models.Model(
        inputs=[input_img, labels], outputs=output, name="OCR_with_LSTM_2"
    )
